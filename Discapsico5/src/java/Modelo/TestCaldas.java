...
import java.sql.Date;
   ...
   public class TestCaldas {
    private int IdRegistro;
    private String numDocumento;
    private Date fechaCaracterizacion;
    ...
    public void setTotalAT(int totalAT) {
        this.totalAT = totalAT;
    }

    public int getTotalDPE() {
        return totalDPE;
    }

    public void setTotalDPE(int totalDPE) {
    ...
    public int getSumatoriaTotal() {
        return sumatoriaTotal;
    }

    public void setSumatoriaTotal(int sumatoriaTotal) {
    ...
    public void setIdRegistro(int IdRegistro) {
      ...
      public Date getFechaCaracterizacion() {
        return fechaCaracterizacion;
    }

    public void setFechaCaracterizacion(Date fechaCaracterizacion) {
        this.fechaCaracterizacion = fechaCaracterizacion;
    }
